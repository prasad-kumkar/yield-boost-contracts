...
library SupplyLogic {
  ...
  function executeSupply(
    ...
    // Mint fees to vault
    uint fee = params.amount * params.supplyFee / 1e18;
    if(fee > 0){
      IERC20(params.asset).safeTransferFrom(msg.sender, IAToken(reserveCache.aTokenAddress).RESERVE_TREASURY_ADDRESS(), fee);
